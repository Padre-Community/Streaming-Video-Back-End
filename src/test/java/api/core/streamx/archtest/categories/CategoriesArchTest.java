package api.core.streamx.archtest.categories;
...
@AnalyzeClasses(packages = "api.core.streamx.modules.categories", importOptions = ImportOption.DoNotIncludeTests.class)
public class CategoriesArchTest {
