package api.core.streamx.archtest.playlist;
...
@AnalyzeClasses(packages = "api.core.streamx.modules.playlist", importOptions = ImportOption.DoNotIncludeTests.class)
public class PlaylistArchTest {
